...
export default function Hero({handleChange, value, handleAdd}){
    ...
    return(
        <div className="grid justify-items-center gap-10 mt-[8%]">
            ...
            <form className="flex justify-between w-1/2 relative" onSubmit={(event)=> handleAdd(event)}>
                <input 
                required
                ...
                className=
                        "text-2xl font-bold bg-green-500 rounded-full text-white px-2 pb-1 absolute right-4 mt-2"
                        >+</button>
            </form>
        </div>
    )
